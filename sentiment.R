...
taylor_lines<-data.frame(new_taylor, "reference"=1:dim(new_taylor))
...
ggplot(albums, aes(track, song_value, colour=album))+geom_label_repel(aes(size=song_sd, label=track_name))
